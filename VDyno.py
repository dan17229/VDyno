...
If using Apple or Linux device, comment out line 238 of VDyno/view/main_window.py: "ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(myappid)"
============================================================
